...
class ContactData {
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (fullname,email,subject, message, created_at) ";
		echo $sql .= "value (\"$this->fullname\",\"$this->email\",\"$this->subject\",\"$this->message\",$this->created_at)";
		Executor::doit($sql);
	}
