...
<html>
  <head>
    <meta charset="UTF-8">
    <title>SysContact | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg">SYS<b>CONTACT</b></span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <?php if(isset($_SESSION["user_id"])):?>
              ...
              <li><a href="./?view=messages"><i class='fa fa-envelope'></i> <span>Mensajes</span></a></li>
              <?php if(Core::$user->status==1):?>
